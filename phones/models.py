...
class PhonesProduct(models.Model):
...
class PhonesReview(models.Model):
    product = models.ForeignKey(PhonesProduct, null=True, on_delete=models.CASCADE, related_name='reviews')
    user = models.ForeignKey(User, null=True, on_delete=models.SET_NULL)
...
@receiver(post_save, sender=PhonesProduct)

...
class VeilsProduct(models.Model):
...
class VeilsReview(models.Model):
    product = models.ForeignKey(VeilsProduct, null=True, on_delete=models.CASCADE, related_name='reviews')
    user = models.ForeignKey(User, null=True, on_delete=models.SET_NULL)
...
@receiver(post_save, sender=VeilsProduct)

...
class FoodsProduct(models.Model):
...
class FoodsReview(models.Model):
    product = models.ForeignKey(FoodsProduct, null=True, on_delete=models.CASCADE, related_name='reviews')
    user = models.ForeignKey(User, null=True, on_delete=models.SET_NULL)
...
@receiver(post_save, sender=FoodsProduct)

...
class SpicesProduct(models.Model):
...
class SpicesReview(models.Model):
    product = models.ForeignKey(SpicesProduct, null=True, on_delete=models.CASCADE, related_name='reviews')
    user = models.ForeignKey(User, null=True, on_delete=models.SET_NULL)
...
@receiver(post_save, sender=SpicesProduct)

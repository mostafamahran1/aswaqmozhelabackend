...
class GiftsProduct(models.Model):
...
class GiftsReview(models.Model):
    product = models.ForeignKey(GiftsProduct, null=True, on_delete=models.CASCADE, related_name='reviews')
    user = models.ForeignKey(User, null=True, on_delete=models.SET_NULL)
...
@receiver(post_save, sender=GiftsProduct)

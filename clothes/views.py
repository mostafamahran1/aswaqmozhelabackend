...
from .models import ClothesProduct, ClothesReview
...
def get_all_products(request):
    ...
    filterset = ProductsFilter(request.GET, queryset=ClothesProduct.objects.all().order_by('id'))
...
def new_product(request):
    ...
    if serializer.is_valid():
        product = ClothesProduct.objects.create(
            name=data['name'],
            price=data['price'],
